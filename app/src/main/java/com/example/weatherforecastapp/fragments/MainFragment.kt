...
import com.example.weatherforecastapp.isPermissionGranted
...
const val API_KEY = "e0bc4c85a3ea467f8a5161503241905"
class MainFragment: Fragment() {
    ...
    private fun updateCurrentCard() = with(binding){
        model.LiveDataCurrent.observe(viewLifecycleOwner){
            val maxMinTamp = "${it.maxTemp}°C/${it.minTemp}°C"
            tvData.text = it.localT
            tvCity.text = it.city
            tvCurrentTemp.text = it.currentTemp.ifEmpty { maxMinTamp }
            tvCondition.text = it.condition
            tvMaxMin.text = if (it.currentTemp.isEmpty())"" else maxMinTamp
    ...
    private fun parseDays(mainObject: JSONObject): List<WeatherModel> {
        ...
        val name1 = mainObject.getJSONObject("location").getString("localtime")
